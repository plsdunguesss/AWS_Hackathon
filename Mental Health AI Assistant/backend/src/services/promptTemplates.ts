...
Help them develop healthier relationship skills and perspectives.`,
    ...
    private containsAnxietyContent(message: string): boolean {
        const anxietyWords = [
    ...
    private containsDepressionContent(message: string): boolean {
    ...
    private containsCopingContent(message: string): boolean {
        const copingWords = [
    ...
    private containsRelationshipContent(message: string): boolean {
