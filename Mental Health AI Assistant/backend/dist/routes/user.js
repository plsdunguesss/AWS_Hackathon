...
router.post('/export/:sessionId', async (req, res) => {
    try {
        ...
        const exportDir = path_1.default.join(process.cwd(), 'temp', 'exports');
        ...
        res.json({
            ...
            fileSize: (await promises_1.default.stat(filepath)).size
        });
    }
    catch (error) {
...
router.get('/download/:filename', async (req, res) => {
    try {
        ...
        const filepath = path_1.default.join(process.cwd(), 'temp', 'exports', filename);
        try {
